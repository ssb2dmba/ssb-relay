...
function run(opts) {
  ...
  tape("relays clients can publish valid messages", function (t) {
    var msgok = {
      ...
      signature:
        "Nrykw5EFQSFbWzZqHKv1hlhEG/DbDbcWGLl+wfxn83Br4yMi5ITmfhjVbHKBd0fki3g7ej4Rddudk7EcO/1nDA==.sig.ed25519",
    };
  ...
  tape(
    "relays clients cannot publish messages with invalid signature",
    function (t) {
      var msgok = {
        previous: null,
        sequence: 1,
  ...
  tape("publish does not store invalid messages", function (t) {
    var msgok = {
      ...
      signature:
        "KlEVtD4E221mJibhXuZCQ15BrsnNNHruepucHqvYnJVvw8UJgl5sL1QPGMATnP7KlkzM3SirUf4/19DkT+4sDQ==.sig.ed25519",
    };
